...
void MALMY_ENGINE_API debugBreak();
void MALMY_ENGINE_API debugOutput(const char* message);


class StackNode;


class MALMY_ENGINE_API StackTree
{
public:
	StackTree();
	~StackTree();
...
class MALMY_ENGINE_API Allocator MALMY_FINAL : public IAllocator
{
public:
...
void MALMY_ENGINE_API enableCrashReporting(bool enable);
void MALMY_ENGINE_API installUnhandledExceptionHandler();
