...
namespace Malmy
{
	...
	private:
		...
		template <R(*Function)()> static MALMY_FORCE_INLINE R FunctionStub(InstancePtr) { return (Function)(); }

		template <class C, R(C::*Function)()> static MALMY_FORCE_INLINE R ClassMethodStub(InstancePtr instance)
		{
			return (static_cast<C*>(instance)->*Function)();
		}

		template <class C, R(C::*Function)() const> static MALMY_FORCE_INLINE R ClassMethodStub(InstancePtr instance)
		{
			return (static_cast<C*>(instance)->*Function)();
		}
	...
	private:
		...
		template <R(*Function)(Args...)> static MALMY_FORCE_INLINE R FunctionStub(InstancePtr, Args... args)
		{
			return (Function)(args...);
		}

		template <class C, R(C::*Function)(Args...)>
		static MALMY_FORCE_INLINE R ClassMethodStub(InstancePtr instance, Args... args)
		{
