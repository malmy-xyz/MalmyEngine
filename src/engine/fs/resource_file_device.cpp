...
class MALMY_ENGINE_API ResourceFile MALMY_FINAL : public IFile
{
public:
...
{
	return MALMY_NEW(m_allocator, ResourceFile)(child, *this, m_allocator);
}
