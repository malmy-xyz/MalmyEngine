...
namespace Malmy
{
	...
	Settings::Settings(StudioApp& app)
		...
		, m_editor(nullptr)
		, m_is_maximized(true)
		, m_is_gameobject_list_open(false)
		, m_is_gameobject_template_list_open(false)
	...
	bool Settings::load()
	{
		...
		m_is_gameobject_list_open = getBoolean(L, "gameobject_list_opened", false);
		m_is_gameobject_template_list_open = getBoolean(L, "gameobject_template_list_opened", false);
	...
	bool Settings::save()
	{
		...
		writeBool("gameobject_list_opened", m_is_gameobject_list_open);
		writeBool("gameobject_template_list_opened", m_is_gameobject_template_list_open);
