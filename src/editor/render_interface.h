...
public:
	...
	virtual AABB getGameObjectAABB(Project& project, GameObject gameobject) = 0;
	...
	virtual Vec3 getModelCenter(GameObject gameobject) = 0;
	...
	virtual WorldEditor::RayHit castRay(const Vec3& origin, const Vec3& dir, GameObject ignored) = 0;
	...
	virtual Vec3 getClosestVertex(Project* project, GameObject gameobject, const Vec3& pos) = 0;
	...
	virtual void getModelInstaces(Array<GameObject>& gameobject, const Frustum& frustum, const Vec3& lod_ref_point, GameObject camera) = 0;
	virtual Frustum getFrustum(GameObject camera, const Vec2& a, const Vec2& b) = 0;
