...
struct OutputStream MALMY_FINAL : public physx::PxOutputStream
{
...
struct InputStream MALMY_FINAL : public physx::PxInputStream
{
...
{
	return MALMY_NEW(m_allocator, PhysicsGeometry)(path, *this, m_allocator);
}


void PhysicsGeometryManager::destroyResource(Resource& resource)
{
	MALMY_DELETE(m_allocator, static_cast<PhysicsGeometry*>(&resource));
}
