...
class MalmyExporter(Operator, ExportHelper):
    bl_idname = "export_scene.malmy_msh"
    bl_label = "Export Malmy Engine Mesh"
...
def menu_func_export(self, context):
    self.layout.operator(MalmyExporter.bl_idname, text="Malmy Mesh (*.msh)")


def register():
    bpy.utils.register_class(MalmyExporter)
    bpy.types.INFO_MT_file_export.append(menu_func_export)


def unregister():
    bpy.utils.unregister_class(MalmyExporter)
    bpy.types.INFO_MT_file_export.remove(menu_func_export)

bl_info = {
    "name": "Malmy Mesh exporter",
    "description": "Export mesh file in the Malmy engine file format",
