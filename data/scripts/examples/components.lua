...
function init()
	...
	void Engine.setGameObjectPosition(Project proj, GameObject gameobject, Vec3 position)
	Vec3 Engine.getGameObjectPosition(Project proj, GameObject gameobject)
	void Engine.setGameObjectRotation(Project proj, GameObject gameobject, Vec3 axis, number angle)
	void Engine.setGameObjectRotation(Project proj, GameObject gameobject, Quat rot)
	Quat Engine.getGameObjectRotation(Project proj, GameObject gameobject)
	GameObject Engine.getParent(Project proj, GameObject child)
	void Engine.setParent(Project proj, GameObject parent, GameObject child)
	void Engine.setGameObjectLocalRotation(Project proj, GameObject gameobject, Vec3 axis, number angle)
	void Engine.setGameObjectLocalPosition(Project proj, GameObject gameobject, Vec3 pos)
